  ...
  return (
    <div ref={root}>
      ...
      <section className="relative px-5 sm:px-6 md:px-12 pt-14 sm:pt-20 pb-8" style={{ background: BG }}>
        <div className="max-w-[1180px] mx-auto reveal relative">
          <div
      ...
      {/* ─── PHOTO STRIP ─── */}
      <div style={{ background: "#F4F8F5", paddingTop: 56, paddingBottom: 0 }}>
      ...
      <div style={{ overflow: "hidden", width: "100%", paddingTop: 0, paddingBottom: 48, background: "#F4F8F5" }}>
